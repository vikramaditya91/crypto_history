...
class BinanceRequester(AbstractMarketRequester):
    """Low level requester for the Binance API. api_key and api_secret are not required to get market information.\
    ...
    async def _request_with_retries(self,
        ...
        try:
            ...
            if e.code == -1003:
                logger.warning("Request could not responds as TOO_MANY_REQUESTS. Waiting before retry")
